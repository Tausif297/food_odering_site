        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Tausif Zakaria" class="input-responsive" required>
                ...
                <?php
                    if (isset($_POST['submit'])) {
                        ...
                        $price = $_POST['price'];                 
                        $qty = $_POST['qty'];
                        $total = $price*$qty; //total = priceXquantity  
