...
<div class="wrapper">
    <h1 style="color: lightgray;">Add Food</h1><br><br>
    <?php  
                    ...
                    <td>
                        <select name="category">
                            <?php 
                                ...
                                //create sql to display all active category
        ...
        <?php
            if (isset($_POST['submit'])) 
            {
                ...
                if (isset($_FILES['image']['name'])) 
                {
                    ...
                    if($image_name !=""){
                        $ext = end(explode('.', $image_name)); //get ectension of selected img
                        $image_name = "Food_name-".rand(0000,9999).".".$ext; //create new image name - new image name is been this
